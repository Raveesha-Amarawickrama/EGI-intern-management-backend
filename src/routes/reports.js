...
const { getInternReport, getProjectReport, getSummary, getSupervisorReport } = require("../controllers/reportController");
...
router.get("/supervisors", protect, getSupervisorReport);
